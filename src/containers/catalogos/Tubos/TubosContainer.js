...
import Tubos from '../../../components/catalogo/tubos/Tubos';
import DataServices from '../../../service/Api';
import ToastContainer from '../../../components/toast/Toast';
//import { useAuth } from '../../../context/Auth';

const TubosContainer = props => {
    const [title, setTitle] = useState('Agregar tubo');
    const [titleForm] = useState('Lista tubos');
    ...
    const getAll = async () => {
        ...
        try {
            const response = await DataServices.getAllTubos();
    ...
    const saveTipoPrueba = async () => {
        ...
        try {
            ...
            const response = await DataServices.postTubo(catTubo);
            if (response.status === 200) {
                setExecuteLoading(false);
                setType("success");
    ...
    const editTipoPrueba = async () => {
        ...
        try {
            ...
            const response = await DataServices.putTubo(catTubo);
            if (response.status === 200) {
                setExecuteLoading(false);
                setType("success");
