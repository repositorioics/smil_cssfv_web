...
import Visitas from '../../../components/catalogo/visitas/Visitas.js';
import DataServices from '../../../service/Api';
import ToastContainer from '../../../components/toast/Toast';
//import { useAuth } from '../../../context/Auth';

const VisitasContainer = props => {
    const [title, setTitle] = useState('Agregar visita');
    const [titleForm] = useState('Lista de visitas');
    ...
    const saveTipoPrueba = async () => {
        ...
        try {
            ...
            const response = await DataServices.postVisita(catVisitas);
            if (response.status === 200) {
                setExecuteLoading(false);
                setType("success");
    ...
    const editTipoPrueba = async () => {
        ...
        try {
            ...
            const response = await DataServices.putVisita(catVisitas);
            if (response.status === 200) {
                setExecuteLoading(false);
                setType("success");
