...
import Consulta from '../../../components/catalogo/consultas/Consultas';
import DataServices from '../../../service/Api';
import ToastContainer from '../../../components/toast/Toast';
//import { useAuth } from '../../../context/Auth';

const ConsultasContainer = props => {
    const [title, setTitle] = useState('Agregar consultas');
    const [titleForm] = useState('Lista de consultas');
            ...
            if (response.status === 200) {
                ...
                for (var i = 0; i < response.data.length; i++) {
                    newData.push({
                        ...
                        "nombre": response.data[i].consulta,
