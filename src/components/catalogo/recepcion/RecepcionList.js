...
//import '../catalogo/recepcion/Recepcion.css';
import '../../../components/catalogo/recepcion/Recepcion.css'
const RecepcionList = props => {
    return (
        <>
            <Loading
            ...
            <Paper className="container" elevation={3} >
                <div style={{ boxShadow: "none" }}>
                    ...
                    <div className="m-top hover">
                        <Link to="/catalogo/registrar-recepcion"><OverlayTrigger placement="bottom" overlay={<Tooltip id="tooltip">Agregar</Tooltip>}>
