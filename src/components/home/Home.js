...
//import FondoPantalla from '../../images/laboratorio3.jpg';

const Home = props => {
    return (
        <div id="home">
            <Paper className="container" elevation={3} style={{marginTop: '15%'}}>
                {/* <Grid container spacing={1} style={{width: '80%', marginLeft: '10%' }}>
