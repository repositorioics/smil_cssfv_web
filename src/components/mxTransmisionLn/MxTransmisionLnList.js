...
const MxTransmisionLnList = props => {
            ...
            <Paper className="container" elevation={3} >
                <div style={{ boxShadow: "none" }}>
                    ...
                    <div className="m-top hover">
                        <Link to="/muestras/agregar-muestra-transmision/lavado-nasal"><OverlayTrigger placement="bottom" overlay={<Tooltip id="tooltip">Agregar</Tooltip>}>
...
export default MxTransmisionLnList;